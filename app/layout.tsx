  ...
  return (
    <html lang="en" className="h-full">
      <body className={`${inter.className} bg-background min-h-full flex flex-col text-foreground`}>
        <ToastProvider>
          {/* Main shell wrapper */}
          <div className="flex-1 w-full max-w-5xl mx-auto bg-background min-h-screen flex flex-col relative pb-24 sm:border-x border-slate-200 dark:border-slate-800 shadow-xs">
            <Header />
